...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  $stmt = $conn->prepare("INSERT INTO bookings (distribution, event_date, budget, functions, about, hear, consultation) VALUES (?, ?, ?, ?, ?, ?, ?)");
  $stmt->bind_param("ssdssss", $distribution, $date, $budget, $functions, $about, $hear, $consultation);

  if ($stmt->execute()) {
    echo "<script>alert('Booking submitted successfully!'); window.location.href='thankyou.php';</script>";
  } else {
